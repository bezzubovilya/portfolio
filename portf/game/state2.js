var state1 = {
    ...
    create: function () {
        ...
        game.physics.arcade.enable(this.analog);
        ...
        game.time.events.add(Phaser.Timer.SECOND * 120, this.updateCounter, this);
    ...
    launch: function () {
        ...
        state1.ball.body.enable = true;
        state1.groupS.enableBody = true;
    ...
    render:function(){
        game.debug.text("Time until event: " + game.time.events.duration/1000, 32, 32,{
            fontSize:"40px"
        });
    }
